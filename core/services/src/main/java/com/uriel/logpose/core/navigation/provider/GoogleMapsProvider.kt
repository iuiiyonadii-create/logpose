package com.uriel.logpose.core.navigation.provider
...
class GoogleMapsProvider : NavigationProvider {
    ...
    override fun open(): NavigationProviderResult {
        return try {
            ...
            AppContextProvider.applicationContext.startActivity(intent)
    ...
    override fun navigate(destination: String): NavigationProviderResult {
        return try {
            ...
            AppContextProvider.applicationContext.startActivity(mapIntent)
    ...
    override fun isInstalled(): Boolean {
        return try {
            AppContextProvider.applicationContext.packageManager.getPackageInfo(packageName, 0)
            true
        } catch (e: Exception) {
            false
        }
