...
object SpotifyWarmUpBinder {
    ...
    private fun executeBind(context: Context, onRejected: () -> Unit) {
        ...
        com.uriel.logpose.core.services.MediaDuckDelegator.duck()
        ...
        wakeupIntent.setPackage("com.spotify.music")
        ...
        try {
            val mediaBrowser = MediaBrowser(
                context,
                ComponentName("com.spotify.music", "com.spotify.music.MediaBrowserService"),
                callback,
                null
            )
