...
object NavigationManager {
    ...
    fun startNavigation(destination: String) {
        ...
        val provider = com.uriel.logpose.core.navigation.provider.NavigationProviderFactory.getBestAvailableProvider()
        ...
        if (result.success) {
            ...
            CoroutineScope(Dispatchers.Main).launch {
                com.uriel.logpose.core.thamis.EventBus.INSTANCE.emit(
