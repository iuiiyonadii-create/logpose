    ...
    fun simulateRemoteAiQuery() {
        scope.launch {
            ...
            if (decision.intent != Intent.UNKNOWN) {
                com.uriel.logpose.core.services.FeedbackDelegator.speak("La IA de tu PC dice que quieres: ${decision.intent}")
            } else {
                com.uriel.logpose.core.services.FeedbackDelegator.speak("No pude conectar con el cerebro de tu PC.")
            }
        }
    }
