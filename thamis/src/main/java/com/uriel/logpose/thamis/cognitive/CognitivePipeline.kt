...
import com.uriel.logpose.thamis.intelligence.MotherbaseBridge
...
object CognitivePipeline {
    ...
    suspend fun processWithAudio(pcmData: ShortArray, voskText: String, noiseLevel: Float) {
        ...
        coroutineScope {
            ...
            val whisperTask = async {
                ...
                val res = com.uriel.logpose.core.services.AudioTranscriptionDelegator.transcribeWhisper(pcmData)
                val text = res ?: ""
            ...
            val sherpaTask = async {
                val t0 = System.currentTimeMillis()
                val text = com.uriel.logpose.core.services.AudioTranscriptionDelegator.transcribeSherpa(pcmData)
        ...
        if (!confidenceReport.isCommandValid) {
            ...
            com.uriel.logpose.core.services.FeedbackDelegator.speak("No entendí la orden, ¿puedes repetirla?")
    ...
    private fun isNetworkAvailable(): Boolean {
        val connectivityManager = com.uriel.logpose.core.compat.core.AppContextProvider.applicationContext.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
        ...
        try {
            ...
            confidenceReport?.let { report ->
                if (!ConfidenceEngine.isSafeToExecute(decision, report)) {
                    ...
                    com.uriel.logpose.core.services.FeedbackDelegator.speak("No entendí bien, ¿podés repetir?")
                    return
                }
            }
            ...
            scope.launch(Dispatchers.IO) {
                ...
                com.uriel.logpose.thamis.intelligence.NeuroEvolutionSimulator.addRealWorldFailure(cleanText, decision.intent)
            }
