...
class WorldModelEngine @Inject constructor(
    ...
    fun update(domain: String, reducer: (WorldSnapshot) -> WorldSnapshot) {
        scope.launch {
            ...
            val json = gson.toJson(newSnapshot)
            com.uriel.logpose.core.services.WorldDiagnosticsDelegator.checkDiagnostics(json)
            ...
            com.uriel.logpose.core.services.WorldDiagnosticsDelegator.updateHud(json)
