...
object SurvivalFilter {
    ...
    fun evaluate(result: RecognizedVoiceCommand, ignoreWakeWord: Boolean = false): FilterResult {
        ...
        val noiseLevel = VoiceEngineDelegator.getAmbientNoiseLevel()
        ...
        val semanticBoost = if (mediaPayload.isNotEmpty() && MusicNormalizerDelegator.isKnown(mediaPayload)) {
            0.15f 
        } else 0f
